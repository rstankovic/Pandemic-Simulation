from scipy.stats import norm #used for gaussian distribution
import random
import time #if we want to watch the simulation run slowly
...
def runDay(daysContagious, lockdown):
    #this section simulates the spread, so it only operates on contagious people
